...
create table tempData( id number not null primary key,name varchar2(50),age integer,gender varchar2(2),religion varchar2(50),height float,occupation varchar2(50),home_Town varchar2(50),language varchar2(50));
